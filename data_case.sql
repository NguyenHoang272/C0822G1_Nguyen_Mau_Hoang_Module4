drop
database if exists case_study_module4_dup;
use
case_study_module4_dup;
...
insert into employee (id, `name`, date_of_birth, id_card, salary, phone_number, email, address, position_id,
                      education_degree_id, division_id, user_name, delete_status)
values (1, 'Nguyễn Văn An', '1970-11-07', '456231786', '10000000', '0901234121', 'annguyen@gmail.com',
        '295 Nguyễn Tất Thành, Đà Nẵng', 1, 3, 1, 'An1', 1),
...
values (1, 'Villa'),
       (2, 'House'),
       (3, 'Room');
insert into facility(id, `name`, area, cost, max_people, standard_room, description_other_convenience, pool_area,
                     number_floors, facility_free, rent_type_id, facility_type_id)
...
INSERT INTO case_study_module4_dup.`contract` (`date_start`, `date_end`, `deposit`, `employee_id`, `customer_id`,
                                               `facility_id`)
...
INSERT INTO case_study_module4_dup.`contract_detail`(`quantity`, `contract_id`, `attach_facility_id`)
VALUES (5, 2, 4),
       (8, 2, 5),
       (15, 2, 6),
       (1, 3, 1),
